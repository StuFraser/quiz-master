export function renderSetupForm(quizTopics, onSubmit) {
  ...
  <div class="setup-container">
    <div class="form-wrapper">
      ...
      <form id="setup-form" class="generator-form">
        ...
        <div class="form-row">
          ...
          <input type="number" name="numQuestions" id="numQuestions" value="15" min="5" max="20" required />
        </div>
        <div class="form-row">
          <label for="numAnswers">Answers per Question:</label>
          <input type="number" name="numAnswers" id="numAnswers" value="5" min="2" max="6" required />
        </div>
    ...
    <div class="instructions-panel">
        ...
        <p class="indented">Enter how many questions you want (between 5 & 20) and how many answer options each question should have (between 2 & 6).  The more answers, the better you score</p>
